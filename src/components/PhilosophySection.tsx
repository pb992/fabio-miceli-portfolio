...
export default function PhilosophySection() {
  return (
    <section className="py-32 px-4 sm:px-6 lg:px-8 bg-white dark:bg-[var(--background)]">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-neutral-800 dark:text-[var(--foreground)] mb-6">
            Non vendo codice.{' '}
          ...
          {pillars.map((pillar, index) => (
            ...
            >
              <div className={`${pillar.bgColor} p-8 rounded-2xl transition-all duration-300 group-hover:shadow-lg dark:group-hover:shadow-primary-500/10 group-hover:-translate-y-2 text-center`}>
                ...
                <h3 className="text-xl font-semibold text-neutral-800 dark:text-[var(--foreground)] mb-3">
                  {pillar.title}
                </h3>
