  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[#0a0a1a]">
        ...
        {/* Grid overlay */}
        <div
          className="absolute inset-0 opacity-[0.02] grid-animated"
          style={{
            backgroundImage: `
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <div className="w-24 h-24 sm:w-28 sm:h-28 mx-auto rounded-full overflow-hidden border-2 border-white/20 shadow-lg shadow-violet-500/20">
              <Image
                src="/fabio_miceli.jpg"
                alt="Fabio Miceli"
                width={112}
                height={112}
